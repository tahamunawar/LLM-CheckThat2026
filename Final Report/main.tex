...
\title[mode=sub]{CheckThat! at CLEF 2026}
...
\author[1]{Taha Munawar}[email=tm08122@st.habib.edu.pk]
\cormark[1]

\author[1]{Abdullah Amir}[email=aa08453@st.habib.edu.pk]

\author[1]{Faisal Alvi}[email=faisal.alvi@sse.habib.edu.pk]

\author[1]{Abdul Samad}[email=abdul.samad@sse.habib.edu.pk]
...
\begin{keywords}
  ...
  Numerical Claim Verification \sep
  Reasoning-Trace Ranking \sep
  Fact-Checking Article Generation \sep
  CEUR-WS
\end{keywords}
...
\par\smallskip
\footnotesize\textit{English is reported as an internal result, whereas Spanish and Arabic have official submissions.}
\end{table}
